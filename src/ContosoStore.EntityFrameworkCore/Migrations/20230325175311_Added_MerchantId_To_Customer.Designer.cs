...
{
    [DbContext(typeof(ContosoStoreDbContext))]
    [Migration("20230325175311_Added_MerchantId_To_Customer")]
    partial class AddedMerchantIdToCustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoStore.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ContosoStore.Merchants.Merchant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMerchants", (string)null);
                });

            modelBuilder.Entity("ContosoStore.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContosoStore.Customers.Customer", b =>
                {
                    b.HasOne("ContosoStore.Merchants.Merchant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ContosoStore.Payments.Payment", b =>
                {
                    b.HasOne("ContosoStore.Customers.Customer", null)
                        .WithMany()
